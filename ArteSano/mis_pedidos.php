        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-10" style="color: white">
                        <h2>Inspeccion de <b>Pedidos</b></h2>
                    </div>
            ...
            <table class="table table-bordered" style="background-color: rgba(255,255,255,0.50); ">
                ...
                <tbody>
                        ...
                        while ($filas = mysqli_fetch_assoc($listar_pedidos)) {
                        ...
                        <tr class=" align-items-center">
                          ...
                          <center> 
                          <td>  <a style="margin: 1rem;" href="Controlador/producto/entregar.php?id_compra=<?php echo $filas['id_compra'] ?>"><i class="fas fa-arrow-alt-circle-right" title="Entregar" style="color: green; font-size: 2rem;"></i></a></td> 
                          </center>
                            </tr>
