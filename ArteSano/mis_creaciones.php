        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-10" style="color: white">
                        <h2>Inspeccion de <b>Creaciones</b></h2>
                    </div>
            ...
            <table class="table table-bordered" style="background-color: rgba(255,255,255,0.50); ">
                ...
                <tbody>
                        ...
                        while ($filas = mysqli_fetch_assoc($lista_por_doc)) {
                        ...
                        <tr class=" align-items-center">
                            ...
                            <center> <td> <a href="modificarP.php?id_producto=<?php echo $filas['id_producto'] ?>"><i class="fas fa-edit" style="color: efb810; font-size: 1.5rem;"></i></a> <a href="Controlador/producto/eliminar.php?id_producto=<?php echo $filas['id_producto'] ?>"><i class="fas fa-trash" style="color: red; font-size: 1.5rem;"></i></a></td> </center>
